...
var router = {
    "/personal": {
        ...
        component: function (resolve) {
            //个人中心首页
            require(['../../oldPages/about-personal-center/index-replace.page'], resolve);
        }
    },
  //消费明细
  "/personal/expense-structure": {
    ...
    component: function (resolve) {
      require(['../../oldPages/personal/expense-structure.page.vue'], resolve);
    }
  },
  //夺宝券说明
  "/personal/snatch-treasure-explain": {
    ...
    component: function (resolve) {
      require(['../../oldPages/personal/snatchexplain.page.vue'], resolve);
    }
  },
  //我的夺宝券
  ...
  //   component: function (resolve) {
  //     require(['../../oldPages/personal/snatch-ticket.page.vue'], resolve);
  //   }
  // },
  //单个私信页面
    "/personal/single-letter/:id": {
      ...
      component: function (resolve) {
        require(['../../oldPages/about-personal-center/single-letter.page'], resolve);
      }
    },
  //全部参与
  "/personal/full-status/:index": {
    ...
    component: function (resolve) {
      require(['../../oldPages/about-personal-center/full-status.page'], resolve);
    }
  }
};
...
pages.forEach(function (page) {
    ...
    router[name] = {
        name:name,
        component: function (resolve) {
            require(['../../oldPages/about-personal-center/'+ page + '.page'], resolve)
        }
    }
});
