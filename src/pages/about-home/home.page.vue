...
<script>
  ...
  import AppSlider from '../../components/feature/about-home/app-slider';
  import AppNavbar from '../../components/feature/about-home/app-navbar';
  import GoodsList from '../../components/feature/about-home/goods-list-v1';
  import AppNotice from '../../components/feature/about-home/app-notice';
  import Gift from '../../components/feature/about-home/gift.component';
  // 登录注册部分
  import Toast from '../../components/feature/about-user-action/toast.component';
  import S1LoginUsePhone from '../../components/feature/about-user-action/s1-login-use-phone.component';
  import S2LoginWithPassword from '../../components/feature/about-user-action/s2-login-with-password.component';
  import S3GetVerificationCode from '../../components/feature/about-user-action/s3-get-verification-code.component';
  import S4SetPassword from '../../components/feature/about-user-action/s4-set-password.component';
