...
import AppNotice from '../../../components/tao-you/notice/notice.component';
import AppAlert from '../../../components/tao-you/dialog/one-button-simple-dialog.component';
import AppToast from '../../../components/tao-you/toast/toast.component';
...
import WechatPayDailog from '../../../components/tao-you/payment/wechat/wechat-pay.component';
...
export default {
  ...
  computed: {
    ...
    alipayConfig() {
      ...
      if (window.API_USE === 1) {
        // 支付完成
        conf.return_url = 'http://1.lly800.com/static/pages/alipay-complete.html';
        // 支付取消
        conf.show_url = 'http://1.lly800.com/static/pages/alipay-cancel.html';
      } else if (window.API_USE === 2) { // 测试的地址
        // 支付完成
        conf.return_url = 'http://release-1.lly800.com/static/pages/alipay-complete.html';
        // 支付取消
        conf.show_url = 'http://release-1.lly800.com/static/pages/alipay-cancel.html';
      } else if (window.API_USE === 4) {
        conf.return_url = 'http://pre.lly800.com/static/pages/alipay-complete.html';
        // 支付取消
        conf.show_url = 'http://pre.lly800.com/static/pages/alipay-cancel.html';
      } else {
        // 支付完成
        conf.return_url = 'http://1.lly800.com/static/pages/alipay-complete.html';
        // 支付取消
      ...
      if (mallUtils.device.isUCBrowser && mallUtils.device.isAndroid) {
        return {
          ...
          show_url: `${location.host}/static/pages/alipay-cancel.html`,
        };
      }
      return conf;
    },
      ...
      switch (type) {
        ...
        case 1:
          paySetting = {
            ...
            uID: localStorage.getItem('uID'),
            return_url: `${location.origin}/static/pages/alipay-complete.html`, // 支付完成
            show_url: `${location.origin}/static/pages/alipay-cancel.html`, // 支付取消
          };
          // 安卓uc下面，支付完成后，会将我们游戏的ucl篡改掉，导致页面停留在了alipay-complete.html页面，
          // 这里暂时返回游戏的登陆页面
          if (mallUtils.device.isUCBrowser && mallUtils.device.isAndroid) {
