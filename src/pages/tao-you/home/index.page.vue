...
import AppFooter from '../../../components/tao-you/layout/footer.component';
import Slider from '../../../components/common-slider/simple-slider.component';
import welcomeAlert from '../../../components/tao-you/reg/regcomplete.component';
import Search from '../game-center-1.2/index/component/game-center-search.component';
import ProgressComponent from '../../../components/tao-you/svg-progress/svg-progress.component';

import DrHomeSlider from '../../../components/common-slider/vue-dr-home-slider.component';
import ScrollNotice from '../../../components/tao-you/notice/game-center-scroll-notice.component';
import Toast from '../../../components/about-user-action/toast.component';
import S1LoginUsePhone from '../../../components/about-user-action/s1-login-use-phone.component';
import S2LoginWithPassword from '../../../components/about-user-action/s2-login-with-password.component';
import S3GetVerificationCode from '../../../components/about-user-action/s3-get-verification-code.component';
import S4SetPassword from '../../../components/about-user-action/s4-set-password.component';

import AppHomeCd from '../../../components/common-cd/app-home-cd';

// 添加回到顶部
import BackTop from '../../../components/tao-you/button/back-top.component';
// 首页消息弹窗
import OneMessage from '../../../components/tao-you/dialog/one-message-dialog.component';
