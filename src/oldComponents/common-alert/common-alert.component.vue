        ...
        <div class="alert-content">
          ...
          <div class="phone-info-item">
            ...
            <p class="vendor-attention">
              拨打
              <span class="c-yidong">10086</span>或者
              <span class="c-yidong">13800138000</span>根据语音提示选择充值卡充值。
            </p>
          </div>
          <!-- 联通 -->
          <div class="phone-info-item">
            ...
            <p class="vendor-attention">
              拨打
              <span class="c-liantong">10011</span>根据语音提示选择充值卡充值。
            </p>
          </div>
          <!-- 电信 -->
          <div class="phone-info-item">
            ...
            <p class="vendor-attention">
              拨打
              <span class="c-dianxin">11888</span>输入18位密码充值,卡号只做备查使用,充值不需要输入卡号。
            </p>
          </div>
          <!-- action btn 确认按钮 -->
...
export default {
  ...
  methods: {
    ...
    closeAlertAndDo() {
      this.showAlert = false;
      this.$emit('common-alert-action');
    },
    neverShow() {
      this.$emit('never-show', this.status);
    },
  },
