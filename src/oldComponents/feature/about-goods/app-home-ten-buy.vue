      ...
      <div class="home-buy-inner">
        ...
        <div class="compute">
          <div class="dr-flex buy-action">
            <button v-touch:tap="decrement" :class="{'disable': this.count <= 10}" class="reduce action-btn-color"></button>
          ...
          <!-- 温馨提示 -->
          <p class="warm-reminders">参与人次必须是10的整数倍</p>
          <div class="dr-flex buy-tips">
            <span v-touch:tap="useTip(10)"
                  @touchstart="useTip(10)"
                  @click="useTip(10)"
                  class="tip flex-1"
                  :class="{'tip--normal': 10 <= canBuyNum, 'tip--disabled': 10 > canBuyNum}">
              10
            </span>
            ...
            <span v-touch:tap="useTip(200)" @touchstart="useTip(200)" @click="useTip(200)" class="tip flex-1" :class="{'tip--normal': 200 <= canBuyNum, 'tip--disabled': 200 > canBuyNum}">200</span>
          </div>
