...
import Vue from 'vue';
import $ from 'jquery';
import SearchBox from './oldComponents/search-box/search-box.component'; // 搜索框
import ProgressComponent from '../../../oldComponents/tao-you/svg-progress/svg-progress.component'; // 圆环进度条
import BackTop from '../../../oldComponents/tao-you/button/back-top.component'; // 添加回到顶部
import BackPrevious from '../../../oldComponents/tao-you/button/return.component';
import LoadList from './oldComponents/load-list/load-list';
