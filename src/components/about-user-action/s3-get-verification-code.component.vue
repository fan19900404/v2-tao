...
<template>
  <div transition="action" v-if="isShow" class="mask flex">
    <div class="action-container">
      ...
      <!-- 输入内容 验证码 -->
      <div class="input-group verification-code flex fix-input-btn">
        <input v-model="vCode" class="verification-code-text flex-1" type="text" placeholder="请输入验证码">
      ...
      <!-- 按钮 -->
      <button :class="{'action-btn--active': isBtnActive, 'action-btn--normal': !isBtnActive}"
              @click="btnAction"
              :disabled="!isBtnActive"
              class="action-btn fix-no-forget">{{btnText}}</button>
